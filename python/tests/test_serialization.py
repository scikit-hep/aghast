...
class Test(unittest.TestCase):
    ...
    def test_serialization_IntegerBinning(self):
        ...
        assert h == frombuffer(h.tobuffer(), checkvalid=True)
        h = Histogram(
            [Axis(IntegerBinning(10, 20, loc_underflow=IntegerBinning.above1))],
            ...
            [
                Axis(
                    IntegerBinning(
                        ...
                        loc_overflow=IntegerBinning.above2,
                    )
                )
            ],
    ...
    def test_serialization_RealOverflow(self):
        h = BinnedEvaluatedFunction(
            [Axis(RegularBinning(10, RealInterval(-5, 5), RealOverflow()))],
            InterpretedInlineBuffer(
                numpy.zeros(10), dtype=InterpretedInlineBuffer.float64
            ),
        )
                ...
                Axis(
                    RegularBinning(
                        ...
                        RealOverflow(
                            loc_underflow=RealOverflow.below1,
                            loc_overflow=RealOverflow.below2,
                            loc_nanflow=RealOverflow.below3,
                        ),
                    )
                )
            ],
            ...
            [
                Axis(
                    RegularBinning(
                        10,
                        RealInterval(-5, 5),
                        RealOverflow(minf_mapping=RealOverflow.in_nanflow),
                    )
                )
            ],
            InterpretedInlineBuffer(
            ...
            [
                Axis(
                    RegularBinning(
                        10,
                        RealInterval(-5, 5),
                        RealOverflow(pinf_mapping=RealOverflow.in_nanflow),
                    )
                )
            ],
            InterpretedInlineBuffer(
            ...
            [
                Axis(
                    RegularBinning(
                        10,
                        RealInterval(-5, 5),
                        RealOverflow(nan_mapping=RealOverflow.missing),
                    )
                )
            ],
            InterpretedInlineBuffer(
    ...
    def test_serialization_StatisticFilter(self):
        h = Histogram(
            [Axis(RegularBinning(10, RealInterval(-5, 5)), statistics=[Statistics()])],
            UnweightedCounts(InterpretedInlineBuffer.fromarray(numpy.arange(10))),
        )
        assert h == frombuffer(h.tobuffer(), checkvalid=True)
        h = Histogram(
    ...
    def test_serialization_Histogram(self):
        h = Histogram(
            [Axis()],
            UnweightedCounts(InterpretedInlineBuffer.fromarray(numpy.arange(1))),
        )
        assert h == frombuffer(h.tobuffer(), checkvalid=True)
