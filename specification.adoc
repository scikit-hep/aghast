...
[%hardbreaks]
•{nbsp}[yellow]#required#  *axis*: list of <<Axis>> with length in [1, ∞)
•{nbsp}[yellow]#required#  *counts*: <<UnweightedCounts>> or <<WeightedCounts>>
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *min*: int in (‒∞, ∞)
•{nbsp}[yellow]#required#  *max*: int in (‒∞, ∞)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *num*: int in [1, ∞)
•{nbsp}[yellow]#required#  *interval*: <<RealInterval>>
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *low*: float in [‒∞, ∞]
•{nbsp}[yellow]#required#  *high*: float in [‒∞, ∞]
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *qmin*: int in (‒∞, ∞)
•{nbsp}[yellow]#required#  *qmax*: int in (‒∞, ∞)
•{nbsp}[yellow]#required#  *rmin*: int in (‒∞, ∞)
•{nbsp}[yellow]#required#  *rmax*: int in (‒∞, ∞)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *edges*: list of float with length in [1, ∞)
•{nbsp} *overflow*: <<RealOverflow>> (default: null)
•{nbsp} *low_inclusive*: bool (default: true)
•{nbsp} *high_inclusive*: bool (default: false)
•{nbsp} *circular*: bool (default: false)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *intervals*: list of <<RealInterval>> with length in [1, ∞)
•{nbsp} *overflow*: <<RealOverflow>> (default: null)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *categories*: list of str
•{nbsp} *loc_overflow*: one of {`+BinLocation.below3+`, `+BinLocation.below2+`, `+BinLocation.below1+`, `+BinLocation.nonexistent+`, `+BinLocation.above1+`, `+BinLocation.above2+`, `+BinLocation.above3+`} +
(default: `+BinLocation.nonexistent+`)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *bins*: list of int
•{nbsp}[yellow]#required#  *bin_width*: float in (0, ∞]
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *predicates*: list of str with length in [1, ∞)
•{nbsp} *overlapping_fill*: one of {`+IrregularBinning.undefined+`, `+IrregularBinning.all+`, `+IrregularBinning.first+`, `+IrregularBinning.last+`} +
(default: `+IrregularBinning.undefined+`)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *variations*: list of <<Variation>> with length in [1, ∞)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *assignments*: list of <<Assignment>>
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *identifier*: unique str
•{nbsp}[yellow]#required#  *expression*: str
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *counts*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *sumw*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *buffer*: buffer
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *pointer*: int in [0, ∞)
•{nbsp}[yellow]#required#  *numbytes*: int in [0, ∞)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *expression*: str
•{nbsp}[yellow]#required#  *statistics*: <<Statistics>>
•{nbsp} *title*: str (default: null)
•{nbsp} *metadata*: <<Metadata>> (default: null)
•{nbsp} *decoration*: <<Decoration>> (default: null)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *sumwxn*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
•{nbsp}[yellow]#required#  *n*: int in [‒128, 127]
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *values*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
•{nbsp}[yellow]#required#  *p*: float in [0.0, 1.0] (default: 1/2)
•{nbsp} *weightpower*: int in [‒128, 127] (default: 0)
•{nbsp} *filter*: <<StatisticFilter>> (default: null)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *xindex*: int in [0, ∞)
•{nbsp}[yellow]#required#  *yindex*: int in [0, ∞)
•{nbsp}[yellow]#required#  *sumwxy*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
•{nbsp} *weightpower*: int in [‒128, 127] (default: 0)
•{nbsp} *filter*: <<StatisticFilter>> (default: null)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *columns*: list of <<Column>> with length in [1, ∞)
•{nbsp}[yellow]#required#  *instances*: list of <<NtupleInstance>> with length in [1, ∞)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *identifier*: unique str
•{nbsp}[yellow]#required#  *dtype*: one of {`+Interpretation.none+`, `+Interpretation.bool+`, `+Interpretation.int8+`, `+Interpretation.uint8+`, `+Interpretation.int16+`, `+Interpretation.uint16+`, `+Interpretation.int32+`, `+Interpretation.uint32+`, `+Interpretation.int64+`, `+Interpretation.uint64+`, `+Interpretation.float32+`, `+Interpretation.float64+`}
•{nbsp} *endianness*: one of {`+Interpretation.little_endian+`, `+Interpretation.big_endian+`} +
(default: `+Interpretation.little_endian+`)
•{nbsp} *filters*: list of {`+Buffer.none+`, `+Buffer.gzip+`, `+Buffer.lzma+`, `+Buffer.lz4+`} +
(default: null/empty)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *chunks*: list of <<Chunk>>
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *column_chunks*: list of <<ColumnChunk>>
•{nbsp} *metadata*: <<Metadata>> (default: null)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *pages*: list of <<Page>>
•{nbsp}[yellow]#required#  *page_offsets*: list of int with length in [1, ∞)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *buffer*: <<RawInlineBuffer>> or <<RawExternalBuffer>>
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *data*: str
•{nbsp}[yellow]#required#  *language*: one of {`+Metadata.unspecified+`, `+Metadata.json+`} (default: `+Metadata.unspecified+`)
...
[%hardbreaks]
•{nbsp}[yellow]#required#  *data*: str
•{nbsp}[yellow]#required#  *language*: one of {`+Decoration.unspecified+`, `+Decoration.css+`, `+Decoration.vega+`, `+Decoration.root_json+`} +
