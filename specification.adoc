...
[%hardbreaks]
•{nbsp}[red]#required#  *axis*: list of <<Axis>> with length in [1, ∞)
•{nbsp}[red]#required#  *counts*: <<UnweightedCounts>> or <<WeightedCounts>>
...
[%hardbreaks]
•{nbsp}[red]#required#  *min*: int in (‒∞, ∞)
•{nbsp}[red]#required#  *max*: int in (‒∞, ∞)
...
[%hardbreaks]
•{nbsp}[red]#required#  *num*: int in [1, ∞)
•{nbsp}[red]#required#  *interval*: <<RealInterval>>
...
[%hardbreaks]
•{nbsp}[red]#required#  *low*: float in [‒∞, ∞]
•{nbsp}[red]#required#  *high*: float in [‒∞, ∞]
...
[%hardbreaks]
•{nbsp}[red]#required#  *qmin*: int in (‒∞, ∞)
•{nbsp}[red]#required#  *qmax*: int in (‒∞, ∞)
•{nbsp}[red]#required#  *rmin*: int in (‒∞, ∞)
•{nbsp}[red]#required#  *rmax*: int in (‒∞, ∞)
...
[%hardbreaks]
•{nbsp}[red]#required#  *edges*: list of float with length in [1, ∞)
•{nbsp} *overflow*: <<RealOverflow>> (default: null)
•{nbsp} *low_inclusive*: bool (default: true)
•{nbsp} *high_inclusive*: bool (default: false)
•{nbsp} *circular*: bool (default: false)
...
[%hardbreaks]
•{nbsp}[red]#required#  *intervals*: list of <<RealInterval>> with length in [1, ∞)
•{nbsp} *overflow*: <<RealOverflow>> (default: null)
...
[%hardbreaks]
•{nbsp}[red]#required#  *categories*: list of str
•{nbsp} *loc_overflow*: one of {`+BinLocation.below3+`, `+BinLocation.below2+`, `+BinLocation.below1+`, `+BinLocation.nonexistent+`, `+BinLocation.above1+`, `+BinLocation.above2+`, `+BinLocation.above3+`} +
(default: `+BinLocation.nonexistent+`)
...
[%hardbreaks]
•{nbsp}[red]#required#  *bins*: list of int
•{nbsp}[red]#required#  *bin_width*: float in (0, ∞]
...
[%hardbreaks]
•{nbsp}[red]#required#  *predicates*: list of str with length in [1, ∞)
•{nbsp} *overlapping_fill*: one of {`+IrregularBinning.undefined+`, `+IrregularBinning.all+`, `+IrregularBinning.first+`, `+IrregularBinning.last+`} +
(default: `+IrregularBinning.undefined+`)
...
[%hardbreaks]
•{nbsp}[red]#required#  *variations*: list of <<Variation>> with length in [1, ∞)
...
[%hardbreaks]
•{nbsp}[red]#required#  *assignments*: list of <<Assignment>>
...
[%hardbreaks]
•{nbsp}[red]#required#  *identifier*: unique str
•{nbsp}[red]#required#  *expression*: str
...
[%hardbreaks]
•{nbsp}[red]#required#  *counts*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
...
[%hardbreaks]
•{nbsp}[red]#required#  *sumw*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
...
[%hardbreaks]
•{nbsp}[red]#required#  *buffer*: buffer
...
[%hardbreaks]
•{nbsp}[red]#required#  *pointer*: int in [0, ∞)
•{nbsp}[red]#required#  *numbytes*: int in [0, ∞)
...
[%hardbreaks]
•{nbsp}[red]#required#  *expression*: str
•{nbsp}[red]#required#  *statistics*: <<Statistics>>
•{nbsp} *title*: str (default: null)
•{nbsp} *metadata*: <<Metadata>> (default: null)
•{nbsp} *decoration*: <<Decoration>> (default: null)
...
[%hardbreaks]
•{nbsp}[red]#required#  *sumwxn*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
•{nbsp}[red]#required#  *n*: int in [‒128, 127]
...
[%hardbreaks]
•{nbsp}[red]#required#  *values*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
•{nbsp}[red]#required#  *p*: float in [0.0, 1.0] (default: 1/2)
•{nbsp} *weightpower*: int in [‒128, 127] (default: 0)
•{nbsp} *filter*: <<StatisticFilter>> (default: null)
...
[%hardbreaks]
•{nbsp}[red]#required#  *xindex*: int in [0, ∞)
•{nbsp}[red]#required#  *yindex*: int in [0, ∞)
•{nbsp}[red]#required#  *sumwxy*: <<InterpretedInlineBuffer>> or <<InterpretedInlineInt64Buffer>> or <<InterpretedInlineFloat64Buffer>> or <<InterpretedExternalBuffer>>
•{nbsp} *weightpower*: int in [‒128, 127] (default: 0)
•{nbsp} *filter*: <<StatisticFilter>> (default: null)
...
[%hardbreaks]
•{nbsp}[red]#required#  *columns*: list of <<Column>> with length in [1, ∞)
•{nbsp}[red]#required#  *instances*: list of <<NtupleInstance>> with length in [1, ∞)
...
[%hardbreaks]
•{nbsp}[red]#required#  *identifier*: unique str
•{nbsp}[red]#required#  *dtype*: one of {`+Interpretation.none+`, `+Interpretation.bool+`, `+Interpretation.int8+`, `+Interpretation.uint8+`, `+Interpretation.int16+`, `+Interpretation.uint16+`, `+Interpretation.int32+`, `+Interpretation.uint32+`, `+Interpretation.int64+`, `+Interpretation.uint64+`, `+Interpretation.float32+`, `+Interpretation.float64+`}
•{nbsp} *endianness*: one of {`+Interpretation.little_endian+`, `+Interpretation.big_endian+`} +
(default: `+Interpretation.little_endian+`)
•{nbsp} *filters*: list of {`+Buffer.none+`, `+Buffer.gzip+`, `+Buffer.lzma+`, `+Buffer.lz4+`} +
(default: null/empty)
...
[%hardbreaks]
•{nbsp}[red]#required#  *chunks*: list of <<Chunk>>
...
[%hardbreaks]
•{nbsp}[red]#required#  *column_chunks*: list of <<ColumnChunk>>
•{nbsp} *metadata*: <<Metadata>> (default: null)
...
[%hardbreaks]
•{nbsp}[red]#required#  *pages*: list of <<Page>>
•{nbsp}[red]#required#  *page_offsets*: list of int with length in [1, ∞)
...
[%hardbreaks]
•{nbsp}[red]#required#  *buffer*: <<RawInlineBuffer>> or <<RawExternalBuffer>>
...
[%hardbreaks]
•{nbsp}[red]#required#  *data*: str
•{nbsp}[red]#required#  *language*: one of {`+Metadata.unspecified+`, `+Metadata.json+`} (default: `+Metadata.unspecified+`)
...
[%hardbreaks]
•{nbsp}[red]#required#  *data*: str
•{nbsp}[red]#required#  *language*: one of {`+Decoration.unspecified+`, `+Decoration.css+`, `+Decoration.vega+`, `+Decoration.root_json+`} +
