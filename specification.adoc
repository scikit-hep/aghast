...
*Represents summary statistics for a <<Histogram>> axis or for each bin in a <<Profile>>.*
...
*Represents one type of moment; a single value for an <<Axis>> or one per bin for a <<Profile>>.*
...
*Represents one type of quantile; a single value for an <<Axis>> or one per bin for a <<Profile>>.*
...
*Represents the mode of a distribution; a single value for an <<Axis>> or one per bin for a <<Profile>>.*
...
*Represents the minimum or maximum of a distribution; a single value for an <<Axis>> or one per bin for a <<Profile>>; also used in <<ColumnChunk>> to summarize data in a column of an <<Ntuple>>.*
