...
*Splits an axis into a contiguous set of integer-sized bins, aligned to integers.*
...
*Splits an axis into an ordered, abutting set of equal-sized real intervals.*
